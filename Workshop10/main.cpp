...
int main() {
   ...
   listArrayElements("All the cars",C,size(C)-1);
   ...
   listArrayElements("All students:",S,size(S));
   ...
   listArrayElements("All employees:",E,size(E));
   ...
   listArrayElements("INTEGERS",a,size(a));
   return 0;
}